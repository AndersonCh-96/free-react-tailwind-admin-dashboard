...
const SignIn: React.FC = (props:any) => {
  ...
  return (
    <>
      ...
      <div className="flex flex-col justify-center xl:h-screen rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
                ...
                <div className="mb-4">
                  ...
                  <div className="relative">
                    ...
                    {validation.touched.email && validation.errors.email ? (
                                                        <p
                                                        className="text-red-500 text-sm">{validation.errors.email}</p>
                                                    ) : null}
...
{validation.touched.password && validation.errors.password ? (
                                                        <p
                                                        className="text-red-500 text-sm">{validation.errors.password}</p>
                                                    ) : null}
